 ...
 * @see FilterInterface
 **/
require_once CORE_PATH . 'components/extensions/filter/filter_interface.php';
...
class Filter
{
	...
	{
		$file = CORE_PATH . "components/extensions/filter/base_filters/{$filter}_filter.php";
		if(!file_exists($file)) {
			$file = APP_PATH . "components/filters/{$filter}_filter.php";
			if(!file_exists($file)) {
