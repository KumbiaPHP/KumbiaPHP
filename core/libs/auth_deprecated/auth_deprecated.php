 ...
 * @see AuthInterface
 */
require_once CORE_PATH . 'libs/auth_deprecated/auth_interface.php';
class AuthDeprecated
{
    /**
    ...
    public function set_adapter ($adapter, $auth = null, $extra_args = array())
    {
        ...
        require_once CORE_PATH . "libs/auth_deprecated/adapters/{$adapter}_auth.php";
