 ...
 */
require_once CORE_PATH . 'modules/extensions/destroyer/destroyer_interface.php';
/**
 * @see ModelDestroyer
 */
require_once CORE_PATH . 'modules/extensions/destroyer/base_destroyers/model_destroyer.php';
/**
 * @see ControllerDestroyer
 */
require_once CORE_PATH . 'modules/extensions/destroyer/base_destroyers/controller_destroyer.php';
/**
 * @see HelperDestroyer
 */
require_once CORE_PATH . 'modules/extensions/destroyer/base_destroyers/helper_destroyer.php';
/**
 * @see FilterDestroyer
 */
require_once CORE_PATH . 'modules/extensions/destroyer/base_destroyers/filter_destroyer.php';
